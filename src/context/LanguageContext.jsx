...
const translations = {
  en: {
    ...
    home: {
      ...
      complianceLabel: 'How we operate',
      complianceTitle: 'OECD & LBMA standards on every mandate',
      complianceDesc:
        'Not a separate product — this is how every trade works: due diligence, KYC/KYB, documented chain of custody, bank-to-bank settlement only.',
      complianceCta: 'Our standards',
  ...
  de: {
    ...
    home: {
      ...
      complianceLabel: 'So arbeiten wir',
      complianceTitle: 'OECD- & LBMA-Standards bei jedem Mandat',
      complianceDesc:
        'Kein eigenes „Produkt“ — so läuft jeder Trade: Due Diligence, KYC/KYB, dokumentierte Lieferkette, nur Bank-zu-Bank.',
      complianceCta: 'Unsere Standards',
  ...
  fr: {
    ...
    home: {
      ...
      heroQuickContact: 'Contact',
      complianceLabel: 'Notre cadre',
      complianceTitle: 'Normes OCDE & LBMA sur chaque mandat',
      complianceDesc:
        'Pas un produit séparé — chaque opération : due diligence, KYC/KYB, chaîne documentée, règlement banque à banque uniquement.',
      complianceCta: 'Nos standards',
  ...
  ar: {
    ...
    home: {
      ...
      complianceLabel: 'كيف نعمل',
      complianceTitle: 'معايير OECD وLBMA في كل تعامل',
      complianceDesc: 'ليس منتجاً منفصلاً — كل صفقة: عناية واجبة، KYC/KYB، سلسلة موثقة، تسوية بنك إلى بنك فقط.',
      complianceCta: 'معاييرنا',
  ...
  zh: {
    ...
    home: {
      ...
      complianceLabel: '运作方式',
      complianceTitle: '每笔业务的OECD与LBMA标准',
      complianceDesc: '不是单独产品——每笔交易：尽职调查、KYC/KYB、可追溯链条、仅银行对银行结算。',
      complianceCta: '我们的标准',
  ...
  ja: {
    ...
    home: {
      ...
      complianceLabel: '当社の枠組み',
      complianceTitle: '全マンデートでOECD・LBMA基準',
      complianceDesc: '別商品ではありません。すべての取引でデューデリジェンス、KYC/KYB、文書化されたサプライチェーン、銀行間決済のみ。',
      complianceCta: '基準を見る',
