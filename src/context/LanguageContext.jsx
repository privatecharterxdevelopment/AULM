...
const translations = {
  ...
  zh: {
    ...
    home: {
      ...
      dubaiDesc: '进口。熔炼。精炼。在全球首屈一指的贵金属交易中心实现完全垂直整合。DMCC和IFZA许可运营。',
      clientsLabel: '机构合作伙伴',
    ...
    contact: {
      label: '联系我们',
      title: '保密咨询',
      desc: '如需就您的需求和我们的当前产能进行保密讨论，请联系我们。',
      hours: '周一至周五 上午8点至下午5点',
      fullName: '全名 *',
      company: '公司/机构',
      email: '电子邮件地址 *',
      inquiryType: '咨询类型',
      goldAcquisition: '黄金采购',
      partnership: '战略合作',
      institutional: '机构咨询',
      message: '您的留言 *',
      send: '发送咨询',
  ...
  ja: {
    ...
    home: {
      ...
      dubaiDesc: '輸入。溶解。精製。世界有数の貴金属取引ハブでの完全な垂直統合。DMCCおよびIFZAライセンス取得。',
    ...
    contact: {
      label: 'お問い合わせ',
      title: '機密相談',
      desc: 'ご要望と当社の現在の対応能力について機密相談をご希望の場合は、お問い合わせください。',
      hours: '月～金 8:00-17:00',
      fullName: '氏名 *',
      company: '会社名/機関名',
      email: 'メールアドレス *',
      inquiryType: 'お問い合わせ種類',
      goldAcquisition: '金の購入',
      partnership: '戦略的パートナーシップ',
      institutional: '機関からのお問い合わせ',
      message: 'メッセージ *',
      send: '送信',
      sending: '送信中...',
      sent: 'メッセージ送信完了',
