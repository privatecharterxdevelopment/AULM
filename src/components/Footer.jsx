      ...
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <p>Responsibly sourcing gold that advances everyday life. IFZA licensed gold trading company based in Dubai Freezone.</p>
          </div>
          ...
          <div className="footer-column">
            ...
            <ul>
              ...
              <li><Link to="/services">B2B Trading</Link></li>
            </ul>
          </div>
        ...
        <div className="footer-bottom">
          ...
          <p className="copyright">&copy; 2026 AULM Trading. All rights reserved. IFZA Licensed.</p>
        </div>
      </div>
    </footer>
  )
