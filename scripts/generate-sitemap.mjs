...
const paths = [
  ...
  { path: '/sell-gold-dubai', priority: '0.95', changefreq: 'weekly' },
  { path: '/buy-gold-dubai', priority: '0.9', changefreq: 'weekly' },
  { path: '/compliance-gold-trading', priority: '0.85', changefreq: 'monthly' },
  { path: '/gold-supply-chain-dubai', priority: '0.85', changefreq: 'monthly' },
